...
function f1(){
    const inputT1 = document.querySelector('.i-1');
    if (+inputT1.value == 4) {
...
function f3(){
    const inputT31 = document.querySelector('.i-31'),
          inputT32 = document.querySelector('.i-32');
    if (+inputT31.value > (+inputT32.value)) {
        document.querySelector('.out-3').textContent = inputT31.value;
    } else {
        document.querySelector('.out-3').textContent = inputT32.value;
    }
    inputT31.value = '';
    inputT32.value = '';
}
...
function f5(){
    const inputT5 = document.querySelector('.i-5');
    if (+inputT5.value < 0) {
        document.querySelector('.out-5').textContent = 'm'; 
    } else if(+inputT5.value == 0) {
...
function f6(){
    const inputT6 = document.querySelector('.i-6');
    if (+inputT6.value % 2 == 0) {
        document.querySelector('.out-6').textContent = 'even'; 
    }  else if (+inputT6.value % 2 == 1) {
...
function f7(){
    const inputT71 = document.querySelector('.i-71'),
          inputT72 = document.querySelector('.i-72');
    document.querySelector('.out-7').textContent = Math.pow(+inputT71.value, +inputT72.value);
    inputT71.value = '';
    inputT72.value = ''; 
}
...
function f9(){
    ...
    if (+inputT9.value > 0 && +inputT9.value < 33 ) {
        document.querySelector('.out-9').textContent = '1';
    } else if (+inputT9.value > 32 && +inputT9.value < 44 ) {
        document.querySelector('.out-9').textContent = '2';
    }else if (+inputT9.value > 43 && +inputT9.value < 65 ) {
...
function f10(){
    ...
    document.querySelector('.out-10').textContent = select10.value;
}
...
function f11(){
    ...
    document.querySelector('.out-11').textContent = select11.value;
}
...
function f13(){
    const inputT13 = document.querySelector('.i-130');
    document.querySelector('.out-13').textContent = (typeof inputT13.value);
    inputT13.value = '';
}
...
function f14(){
    const inputT141 = document.querySelector('.i-141'),
          inputT142 = document.querySelector('.i-142'),
          selectT14 = document.querySelector('.s-143');
    if (selectT14.value == "+") {
        document.querySelector('.out-14').textContent = +inputT141.value + (+inputT142.value);
    } else if (selectT14.value == "*") {
        document.querySelector('.out-14').textContent = +inputT141.value * (+inputT142.value);
    } else if (selectT14.value == "/") {
        document.querySelector('.out-14').textContent = +inputT141.value / (+inputT142.value);
    }else if (selectT14.value == "-") {
...
function f15(){
    const selectT151 = document.querySelector('.s-151'),
          selectT152 = document.querySelector('.s-152'),
          selectT153 = document.querySelector('.s-153');
    switch (selectT153.value) {
        case '&&':
            if (selectT151.value == 1 && selectT152.value == 1) {
                document.querySelector('.out-15').textContent = '1';
            } else {
