...
function t1() {
    let out = document.querySelector('.out-1').textContent = document.querySelector('.div-1').textContent;
    return out;
}
...
function t2(e) {
    let out = '';
    if (e.altKey) {
        out = document.querySelector('.out-2').textContent = 'true';
    } else {
        out = document.querySelector('.out-2').textContent = 'false';
    }
    return out;
}
...
function t4() {
    let out = document.querySelector('.out-4').textContent = document.querySelector('.div-4').textContent;
    return out;
}
...
// Task 5 ============================================
/*  Дан блок .div-5.active. Добавьте на него событие двойной клик, по которому удалется 
класс active если он есть и добавляется если такого класса нет. */
...
// Task 6 ============================================
/*  Дан блок .div-6 и список .ul-6. При двойном клике на блоке скрывайте 
.ul-6 еcли он показан и показывайте если скрыт. 
...
// Task 7 ============================================
/*  Дан блок .div-7. При клике правой кнопкой мыши на блоке 
добавляйте ему класс .active. При повторном клике - удаляйте. */
...
документе отключается клик правой кнопкой мыши если checkbox 
выбран и отключает если не выбран. */
...
function t9() {
    let png = document.querySelector('.div-9 img');
    png.src = "img/2.png";
}
...
function t11() {
    let png = document.querySelector('.div-11 img');
    png.src = "img/2.png";
    png.alt = "text-11";
...
- добавляйте ему класс active. Добавьте ему событие mouseup 
...
function t16() {
    document.querySelector('.div-16').style.height = w3 + 'px';
    w3++;
}
document.querySelector('.div-16').addEventListener('mousemove', t16);

// Task 17 ============================================
/*  Дано две кнопки - b-17_on и b-17_off. Напишите фукнции t17On и t17Off 
которые включают и отключают событие move в задании 16. */
...
function t18() {
    document.querySelector('.div-18').textContent = `height: 75px`;
}
...
function t19() {
    document.querySelector('.div-19').textContent = `div-19 block task-19-block`;
}
