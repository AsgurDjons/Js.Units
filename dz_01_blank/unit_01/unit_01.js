...
// Создайте div с классом one. С помощью document.querySelector запишите в данный элемент текст 'Hello World'.
 const classOne = document.querySelector('.one');
    classOne.textContent = 'Hello World';
...
const everyone  = document.querySelector('span');
everyone.textContent = 'world';
...
three.innerHTML = '<h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eiuscupiditate porro, consequatur corrupti quia vel, fuga ipsa illo earum quidem veniam. Corporis deleniti esse, perferendis non modi odit rerum animi.</h3>';
// Task 11.
...
four.innerHTML = '<h4>Lorem ipsum dolor sit amet</h4><p>Lorem ipsum dolor sit amet</p>';
...
a.classList.add('five');
a.innerHTML = 3.1415;
document.querySelector('.five').append(a);
