...
function f5() {
    ...
    if (checkbox.checked) {
        document.querySelector('.out-5').textContent = checkbox.value;
    } else {
...
function f6() {
    let inputT6 = document.querySelector('.i-6');
    document.querySelector('.out-6').textContent = inputT6.value;
}
...
function f7() {
    let inputT7 = document.querySelector('.i-7');
    document.querySelector('.out-71').textContent = inputT7.value;
    if(inputT7.value.length >= 5) {
        document.querySelector('.out-72').textContent = '1';
    }else if (inputT7.value.length <= 5) {
...
function f8() {
    ...
    //    ваша созданная кнопка.onclick = f81;
    //
    let adForm = document.querySelector('.out-8');
    adForm.innerHTML = '<div class="form-control"><input type="text" class="i-81"></div><button class="button-primary b-81">Task-8</button>';
    document.querySelector('.b-81').addEventListener('click', () => {
        f81 ();
    });
}

function f81 () {
    let inputT8 = document.querySelector('.i-81');
    document.querySelector('.out-81').textContent = inputT8.value;
}
...
function f9() {
    ...
    if (radio.checked) {
        document.querySelector('.out-9').textContent = radio.value;
    } else {
...
function f10() {
    ...
    document.querySelector('.out-10').style.backgroundColor = inputT10.value;
}
...
function f11() {
    let input1 = document.querySelector('.i-111'),
        input2 = document.querySelector('.i-112');
...
function f12() {
    ...
    document.querySelector('.out-12').textContent = input.value;
}
...
function f13() {
    const input = document.querySelector('.i-13');
    document.querySelector('.out-13').textContent = input.value;
}
...
function f14() {
    ...
    document.querySelector('.out-14').textContent = input.value;
}
...
function f15() {
    const input = document.querySelector('.i-15'),
          input2 = document.querySelector('.t-15');
    input2.value = input.value;
    document.querySelector('.out-15').textContent = input.value;
}
...
function f16() {
    ...
    document.querySelector('.out-16').textContent = select.value;
}
...
function f17() {
    ...
    document.querySelector('.out-17').textContent = select.value;
}
...
function f18() {
    let select = document.querySelector('.s-18'),
        input = document.querySelector('.i-18');
...
function f19() {
    let input1 = document.querySelector('.i-191'),
        input2 = document.querySelector('.i-192');
    input2.value = input1.value;
}
...
function f20(e) {
    ...
    document.querySelector('.out-20').textContent = `${form.elements['username'].value} ${form.elements['password'].value}`;
